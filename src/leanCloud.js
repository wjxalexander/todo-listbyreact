import AV from 'leancloud-storage'
 ...
 var APP_ID = 'Ucrhl38NwXcu10PAA8p0zAVh-gzGzoHsz'
 var APP_KEY ='XPpoiKxaUHiwgrVUAplwgtMC'
 AV.init({
   appId: APP_ID,
   appKey: APP_KEY
 })
...
export function signOut(){
 ...
 export function sendPasswordResetEmail(add, successFn, errorFn) {
  AV.User.requestPasswordReset(add).then(function (success) {
    successFn.call() 
  }, function (error) {
    console.dir(error)
  });
